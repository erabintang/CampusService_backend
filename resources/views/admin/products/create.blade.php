...
@section('content')
    <div class="mx-auto max-w-3xl rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
        <div class="border-b border-gray-100 px-6 py-5">
            ...
            <p class="text-sm text-gray-500">Buat layanan baru yang ditawarkan kepada user.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mt-6 flex items-center justify-end gap-3 border-t border-gray-100 pt-5">
                ...
                <button type="submit" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-indigo-700">Simpan Produk</button>
            </div>
        </form>
    </div>
@endsection
